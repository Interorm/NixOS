...
in {
    ...
    services.hermes-agents.agents.sabine = {
        ...
        # Home Assistant only -- her agent has no reason to reach GitHub,
        # crawl the web, or read Nix options, and a smaller tool surface is
        # also a smaller blast radius on an account she drives herself.
        mcpServers = {
        ...
        soul = ''
            ...
            (home-assistant) that can do everything:
